  ...
  render() {
    return (
      <div className={ styles.about }>
        ...
        <p className={ styles.purple }><a href='https://github.com/JoeKarlsson1/post-stream' target='_blank'>PostStream is completely open source</a>, feel free to fork it or contribute new features.</p>
        ...
        <p className={ styles.lightGreen }>we are always looking to improve - if you find a bug, please report it <a href='https://github.com/JoeKarlsson1/post-stream/issues' target='_blank'>here</a>.</p>
