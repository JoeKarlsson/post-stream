  ...
  render() {
    return (
      <div className={styles.about}>
        ...
        <p>site by <a href='http://www.rayfarias.com' target="_blank">ray</a>, <a href='http://jacobyyoung.com/' target="_blank">jacoby</a> and <a href='http://www.callmejoe.net/' target="_blank">joe</a></p>
        <img src={logo} />
      </div>
    );
  }
